...
//字库存放在磁盘中的路径
char*const GBK24_PATH="/SYSTEM/FONT/GBK24.FON";		//GBK24的存放位置
char*const GBK16_PATH="/SYSTEM/FONT/GBK16.FON";		//GBK16的存放位置
char*const GBK12_PATH="/SYSTEM/FONT/GBK12.FON";		//GBK12的存放位置
char*const UNIGBK_PATH="/SYSTEM/FONT/UNIGBK.BIN";		//UNIGBK.BIN的存放位置
