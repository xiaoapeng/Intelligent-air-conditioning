...
* @{
*/
#define PRODUCT_KEY "ff47a319f27f4a788ea7d3a0aeadb16b"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "ea6efe23230f471bb3d183b5510d9f8f"
...
#define LED2_BITOFFSET                     0
#define LED2_LEN                           1
#define State_Conditioning_BYTEOFFSET                    0
#define State_Conditioning_BITOFFSET                     1
#define State_Conditioning_LEN                           1
#define Intelligent_model_BYTEOFFSET                    0
#define Intelligent_model_BITOFFSET                     2
#define Intelligent_model_LEN                           1
#define buzzing_BYTEOFFSET                    5
#define buzzing_BITOFFSET                     0
#define buzzing_LEN                           1

#define Target_Temperature_RATIO                         1
#define Target_Temperature_ADDITION                      16
#define Target_Temperature_MIN                           0
#define Target_Temperature_MAX                           16
#define Room_Temperature_RATIO                         1
#define Room_Temperature_ADDITION                      -10
#define Room_Temperature_MIN                           0
#define Room_Temperature_MAX                           110
#define room_humidity_RATIO                         1
#define room_humidity_ADDITION                      0
#define room_humidity_MIN                           0
#define room_humidity_MAX                           100
#define illumination_intensity_RATIO                         1
#define illumination_intensity_ADDITION                      0
#define illumination_intensity_MIN                           0
#define illumination_intensity_MAX                           100
/**@} */
...
typedef struct {
  bool valueLED2;
  bool valueState_Conditioning;
  bool valueIntelligent_model;
  uint32_t valueTarget_Temperature;
  int32_t valueRoom_Temperature;
  uint32_t valueroom_humidity;
  uint32_t valueillumination_intensity;
  bool valuebuzzing;
} dataPoint_t;
...
typedef struct {
  uint8_t flagLED2:1;
  uint8_t flagState_Conditioning:1;
  uint8_t flagIntelligent_model:1;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueTarget_Temperature;
  uint8_t valueRoom_Temperature;
  uint8_t valueroom_humidity;
  uint8_t valueillumination_intensity;
